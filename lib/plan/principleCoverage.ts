...
export const PRINCIPLE_COVERAGE: readonly PrincipleCoverage[] = [
  ...
  { n: 117, by: 'invariant', ref: 'INV-PLAN-RUNWALK-PRESCRIBED' },  // Finish-goal run-walk marathon. The invariant covers amendment 3 (the interval is PRESCRIBED on every running session), which is the whole safety argument for the lower door. It does NOT cover the peak value itself (amendment 1) — that is a config numeric governed by configPrincipleSync, not a property of a generated plan.
] as const
