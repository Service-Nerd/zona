...
export const PRINCIPLE_COVERAGE: readonly PrincipleCoverage[] = [
  ...
  { n: 118, by: 'invariant', ref: 'INV-PLAN-GET-RUNNING-BUILD-RATIO' },  // The get-running plan. ⚠️ The invariant covers the TOTAL BUILD ceiling (amendment 2) — the §2 blind spot this section exists to close. It does not cover the plan's ADEQUACY, because a plan with no race has no adequacy bar to hold it to, which is also why no harness watches this plan kind.
] as const
