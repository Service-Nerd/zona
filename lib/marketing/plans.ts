...
export const MARKETING_PLANS: MarketingPlan[] = [
  ...
  },
  {
    ...
    extraFaqs: [{ q: 'What pace is a sub-45 10K?', a: '4:30 per kilometre (about 7:14 per mile), held for 10 km. This is a sharp target, so the plan spends most of the week well below it so the fast running lands on fresh legs.' }],
  },
  {
