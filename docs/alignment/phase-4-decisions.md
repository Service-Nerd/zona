...
| 17 | Device test 2026-04-24 | Enricher prompt: banned frequency-based week labels ("Light", "Heavy", "Moderate"). Phase-based language only. | Calling a 3-day schedule "Light" judges the user — contradicts Vetra's core positioning. | Low |
