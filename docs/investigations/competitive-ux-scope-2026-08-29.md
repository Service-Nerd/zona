...
- **RESOLVED 2026-08-29 (CD-21 + founder call):** weight/height = **not collecting** (no engine use). Gender = **deferred / not collecting** — the female-physiology roadmap is **not committed**, so CD-21b's condition isn't met; revisit only when it is.
