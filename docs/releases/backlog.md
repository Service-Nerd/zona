...
**State at END of 2026-09-23 (last ship `884bd5c`, `DATE-OWNER-01`) — PUSHED.** 3,246 tests · 364 files. 🥇 **ASKED FOR A DATE PREFERENCE, I MEASURED FIRST AND BUILT THE OPPOSITE.** 9 formats · 22 sites · no owner · all `'en-GB'` · **one RAW ISO on the plan reveal** — but **NOT ONE FORMAT WAS AMBIGUOUS** (every one names its month), and **no date preference exists** to follow. **SLT killed the setting** (Fried: *"permanent surface area… to change WORD ORDER for people who can already read the date"*) and ruled: **build the owner.** ⚠️ **Blast radius measured BEFORE building, at the founder's instruction** — round-trip **0**, persisted **0**, sorted/compared **0**, server-side **0**, tests asserting a format **0**; `plan_start`/`race_date` stay ISO. 🔴 **A SHADOWED LOCAL `formatDate` BECAME INFINITE RECURSION**, caught **only** by an arity mismatch — matching signatures would have type-checked and hung. 🔴 **AND THE ACTION-ROW PATTERN WAS ALREADY DOCUMENTED** as `### 20. Action List Card`, chevron and all; my duplicate was caught by the numbering test, not by me. 🥇 **A DOCUMENTED PATTERN WITH NO COMPONENT GETS RE-IMPLEMENTED FROM MEMORY — prose cannot be imported.** Earlier: `APP-SPACE-01` (**we fixed the website and forgot the product** — 17 token uses in marketing, **0** in the app) + `ACTION-ROW-01`, `LONGRUNSHORT-RUNWALK-KEY-01`, `MARA-LR-SHAPE-SEAM-01`/§117 Am.4, `RUNWALK-VISIBLE-01`, `UNITS-DURATION-01`, `UNITS-PROSE-01` (CLOSED), `UNITS-SUBUNIT-01`, `PACE-UNITS-01`, `COMPLETION-TOMBSTONE-01`, `COACH-MEASURE-PROTOCOL-01`, `ZERO-REJECTION-SERVED-01`, `COHORT-SERVED-01`, `ONRAMP-STEP-UNITS-01`, `REFUSAL-COHERENCE-01`, `REFUSAL-FINISH-ROUTE-01`, `COACH-REVIEW-2026-09-23`, `RUBRIC-STALE-BAR-01`, `DB-USER-PURGE-01`.
