...
**State at END of 2026-09-20 (last ship `3522842`):** tree clean · `verify` exit 0 · **2,613 tests / 297 files** · **128 invariants** · `audit-docs.sh` ALL CLEAN. 🔴 **THE HEADLINE NUMBER CHANGED TWICE TODAY AND BOTH TIMES IT GOT WORSE WITHOUT THE ENGINE CHANGING.** `measure:envelope` scored a REFUSAL as fit-for-purpose, and its population excluded every runner below 6 km/wk. Corrected: **whole product 95.9% → 92.2%, marathon 90.1% → 77.6%.** Every other distance clears the 90–95% bar (5K/10K/50K/100K 100%, HM 96.2%). **The marathon is the only failure and the entire 12.4-point gap is REJECTION.** **Founder's bar, stated repeatedly: nobody who asks for a plan gets told no.** **Built today, both DARK:** §116 base-build on-ramp (the remedy §111 named and §57 made impossible — flat from week 2 at any length) and §117 finish-goal run-walk. 🔴 **§117 WAS BUILT, MEASURED, AND DOES NOT WORK: 77.6% fit with the flag either way** — refusals became LONG-RUN-SHORT plans one for one, because §117's plans reach 39–44% of race duration against §80's 70% bar. **Willy's amendment 1 specified both a 30–34 km peak AND '3+ hours on feet' and they do not reconcile under §52's 60% cap** (`S117-PEAK-VS-TIME-01`, board). ⚠️ **The mandatory conflict scan MISSED §111's worked example and a test caught it** (§111 Am.3). ⚠️ **Nothing has run on a device.** 🔻 **Yours:** `OPS-VERCEL-PLAN-01` + `OPS-SUPABASE-PLAN-01` (P0) · `LEGAL-COUNSEL-01` · `SIGNPOST-HARM-01` · the `/pricing` wording · the net-revenue conclusions · `P-04`'s zero-case words.
