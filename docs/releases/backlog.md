...
| **W6** | **Debt & cosmetic** — fill gaps between waves; none blocks anything | ~~DS-06~~ ✅ · DS-07 (table rename) · Universal Links · BRAND-02/03/05/07/08/09/11/13 · Vercel project rename · Tier-divergent rendering utility · FMT-02 · R23-D1 · R23-D3 | No-regret cleanup; slot opportunistically. |
