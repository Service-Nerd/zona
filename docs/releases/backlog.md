...
**State at END of 2026-09-23 (last ship `6f9a139`, `MARA-LR-SHAPE-SEAM-01` / §117 Am.4) — PUSHED.** 3,229 tests · 361 files. 🥇 **I SHIPPED A CHANGE THAT MADE THE HEADLINE METRIC WORSE, ON PURPOSE, AND PREDICTED THE DIRECTION BEFOREHAND.** §117 bundled a **lower peak** with a **run-walk instruction**; a §12 volume-capped runner needs the second and not the first — **their door is already open** because the injury cap lowered their peak for them, so they paid the reduction twice and it pushed their long run **17km → 13km**, below §117 Am.2's own bound, and the gate **REFUSED** them. **Isolated by SWEEPING THE CONSTANT** (34→13, 38→14, 42→15, 46→16, 50→17, 52→17, 56→19) rather than reasoning about it. ⚠️ **An OMISSION, not a contradiction** — §117 and its 3 prior amendments never mention injury. 🔴 **Refusals at 8km/wk 85.8% → 69.1% (−16.7pp), `LONG-RUN-SHORT` +16.6pp — MATCHING ONE-FOR-ONE**, the arithmetic proof nothing else moved. **Marathon fit FELL 89.8% → 89.1%.** Hutchinson, binding: *the inverse of this morning's re-score — then the number rose and nobody was served differently; now it falls and 16.7pp of a cohort get a plan.* **A rate is not a goal; what it counts is.** ⚠️ **THE LIVENESS GATE CAUGHT MY OWN CHANGE** — splitting the flag made an existing invariant UNWAKEABLE and it failed in the same commit. ⚠️ **My filed seam premise was WRONG** (3rd instrument fault in the thread, all caught before a seat spoke). Earlier: `RUNWALK-VISIBLE-01` (**a prescription written and rendered NOWHERE, 0 commits ever**), `UNITS-DURATION-01`, `UNITS-PROSE-01` (4 phases, CLOSED), `UNITS-SUBUNIT-01`, `PACE-UNITS-01`, `COMPLETION-TOMBSTONE-01`, `COACH-MEASURE-PROTOCOL-01`, `ZERO-REJECTION-SERVED-01`, `COHORT-SERVED-01`, `ONRAMP-STEP-UNITS-01`, `REFUSAL-COHERENCE-01`, `REFUSAL-FINISH-ROUTE-01`, `COACH-REVIEW-2026-09-23`, `RUBRIC-STALE-BAR-01`, `DB-USER-PURGE-01`.
