...
**State at END of 2026-09-20 (last ship `c8a56ec`):** tree clean. **2,536 tests / 288 files** · **124 invariants** · `verify` exit 0 · sweep 14,189 plans no new violations · `audit:plans` no regression · **`measure:envelope` UNCHANGED on every distance, whole product 95.9%** (5K/10K/50K/100K 100%, HM 96.2%, marathon 90.1%). **NINE SHIPS after the Miles teardown:** §80 Am.2 (`MARA-LR-LOWBASE-01`) · `REFRAME-NOTE-LOSS-01` · `P-13a/b` colour guard · `P-03` pace ceiling · `P-01` semantic pair · `ENRICH-PII-MINIMISE-01` · `LEGAL-PRIVACY-01` · `CONSENT-DISCLOSURE-01`. ⚠️ **The founder's constraint held and was PROVEN each time, not asserted: the 95.9% did not move.** ⚠️ **Nothing has run on a device.**
