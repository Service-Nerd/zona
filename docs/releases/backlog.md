...
**State at END of 2026-09-23 (last ship `9bba012`, `MODIFY-SHEET-01`) — PUSHED.** 3,254 tests · 366 files. 🥇 **"I JUST DON'T LIKE IT" IS A SYMPTOM, AND MEASURING IT COST ME TWO OF MY OWN FOUR FINDINGS.** The day selector wrapped **6 + "Sun" alone**; ⚠️ **seven across is NOT AVAILABLE at 375pt** (7×44 + 6×8 = **356** vs ~**307**; **even at zero gap 308 > 307**), so one row costs the **44px tap target** — the wrap is now **deliberate 4 + 3**. **An orphan reads as a mistake; a balanced pair reads as a layout.** Removed the **only dashed border in the product**. 🔴 **WITHDRAWN as over-called**: *"four radii"* (two are a circular button + a 6px dot) and *"injury chips orphan"* (variable-width pills — wrapping is what chips do). 🔻 **Race date DEFERRED — needs a device.** 🔻 **"No single control vocabulary" RECORDED AND UNRESOLVED** (4 species remain); founder told plainly the tidy-ups **may not make him like it**. Earlier: `PREVIEW-STRIP-01` (**two bar charts, only one meant anything**), `DATE-OWNER-01` (**asked for a preference, built the opposite**), `APP-SPACE-01` + `ACTION-ROW-01` (**we fixed the website and forgot the product**), `LONGRUNSHORT-RUNWALK-KEY-01`, `MARA-LR-SHAPE-SEAM-01`/§117 Am.4, `RUNWALK-VISIBLE-01`, `UNITS-DURATION-01`, `UNITS-PROSE-01` (CLOSED), `UNITS-SUBUNIT-01`, `PACE-UNITS-01`, `COMPLETION-TOMBSTONE-01`, `COACH-MEASURE-PROTOCOL-01`, `ZERO-REJECTION-SERVED-01`, `COHORT-SERVED-01`, `ONRAMP-STEP-UNITS-01`, `REFUSAL-COHERENCE-01`, `REFUSAL-FINISH-ROUTE-01`, `COACH-REVIEW-2026-09-23`, `RUBRIC-STALE-BAR-01`, `DB-USER-PURGE-01`.
