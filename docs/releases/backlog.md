...
*Shipped 2026-06-22 → feature-registry: ENGINE-02 (long-run shortfall, + fixed ENGINE-01's latent trigger-constraint bug), DS-05 (sleep stages), DS-07 (composite effort — both Part A edit-distance + Part B add-effort), CA-03 (post-race goal ladder). Earlier: GTM-08/09/10, R25 cuts 2–3, CA-01, CA-04, UPGRADE-ENTRY-01. All migrations applied to live Supabase.*
