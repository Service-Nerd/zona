...
**Everything is committed** (`57fc583`, with the behavioural-test pass `cb6ccba` on top). `npm run verify` exit 0 (**2154 tests / 236 files**) · `npm run check:db` exit 0 · sweep **15,974 plans, no new violations** · HIGH 0 / MED 26.
