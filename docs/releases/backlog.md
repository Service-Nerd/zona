...
| GTM-09 | **Trial expiry email** (day 14) — "Your zone coaching pauses today." Requires email platform (Resend or Supabase Edge + SMTP). **SLT priority #1.** | M | PAID | High |
| GTM-10 | **Trial nudge email** (day 11) — "3 days of full access left." Same infra as GTM-09, ships together. **SLT priority #1 (ships with GTM-09).** | S | PAID | Medium |
