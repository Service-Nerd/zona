...
**State at END of 2026-09-19 (last ship `dabf4b9`):** ✅ tree clean. **2,464 tests / 278 files** · **124 invariants** · sweep **14,189 plans, no new violations** · `audit:plans` no regression · `audit-docs.sh` ALL CLEAN. 🔴 **THE HEADLINE IS NOW A NUMBER: fit-for-purpose is 66.7% of the weighted population against a 90–95% target** — 5K **50.6%** · 10K 59.3% · HM 70.3% · marathon 67.4% · 50K 91.6% · 100K 89.9%. ⚠️ **THE SHORT RACES ARE THE WORST AND NOBODY HAD LOOKED** — every sitting this month was about the marathon. **Two dominant faults, both cross-distance and both new:** `DAYS-SHORT` **18.7%** (runner declares N days, plan gives fewer, **no note**) and `WEEK1-LEAP` **14.0%** (week 1 >1.30× real start). 🔴 **FILED: 8 of 366 sampled 100K plans ship INVALID** (recalibration week with no benchmark session); the sweep is green because its grid cannot build that runner. ⚠️ Board VETOED a load-aware difficulty band — do not re-propose. ⚠️ Device verification remains founder-owned and OPEN.
