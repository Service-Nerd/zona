...
**State at END of 2026-09-19 (last ship `3ee7d76`):** ✅ tree clean. **2,478 tests / 281 files** · **124 invariants** · sweep **14,189 plans, no new violations** · liveness **121/124** · `audit:plans` no regression · `audit-docs.sh` ALL CLEAN. 🥇 **FIT FOR PURPOSE 66.7% → 85.3%** against the 90–95% target, measured on the weighted population: **5K 100%** · 10K 78.3% · HM 85.4% · **marathon 73.9%** · 50K 94.3% · 100K 93.5%. Marathon is now the weakest and its gap is **17.3% designed refusals**, which measurement showed are CORRECT — excluding them, **89.4% of the marathon plans we generate are fit to hand over**. **Shipped:** `COPY-STALE-GEN-01` (96 invalid 100K plans → 0; the repair existed with one caller) · `FREQ-SILENCE-01` (18.7% were given fewer days than declared, silently) · `WEEK1-LEAP-ABS-01` · `ULTRA-LR-BAR-01` · `ENVELOPE-COHERENCE-01`. 🔴 **TWO DISSOLVED ON MEASUREMENT — do not re-derive:** §111 cap-instead-of-refuse (100% of refused cases would get a peak below the credible floor, median 22.4 vs 52.8 km; **§111's door is arithmetically exact: 52.8 ÷ 4 = 13.2**) and beginner finish-goal quality (§110 Am.2 ruled it unanimously the same morning). 🟡 **Open, filed with numbers:** `WEEK1-FLOOR-SHORT-DIST-01` (four caps built, every one made BINGE-WEEK 8–12× worse) · `ULTRA-LR-ADEQUACY-01` · `S111-SUBFLOOR-VOLUME-01` (charity question unsent). ⚠️ **Device verification remains founder-owned and OPEN — nothing shipped today has run on a device.**
