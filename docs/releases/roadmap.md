...
| **FOUNDATION-QUALITY-YIELD-01** — §91's on-ramp credit spends §1's headroom | FREE | S | **Coaching Board REQUIRED — changes what a demonstrated runner is prescribed.** §91 shipped claiming *"does not loosen §1"*; it does — 19.0% (15/79) vs MARATHON's 18%, confirmed under production semantics. Board ruled §1 binds but deliberately did **not** settle *which lever yields*. Sweep baseline held at 2 as declared debt; must reach 0. |
