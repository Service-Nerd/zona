...
| **ONSET-INTENSITY-YIELD-01** (was FOUNDATION-QUALITY-YIELD-01) — §89's early onset breaches §1 | FREE | M | **P1. Coaching Board ratified the DIAGNOSIS 2026-09-10; the remedy is NOT settled.** Re-scoped: the cause is **§89's early quality onset**, not §91's foundation credit — isolation on 120 comparable cells gives **29 breaches with the gate open, 0 with it closed**, and 11 of the 29 carry no foundation block at all. Worst measured **HM@3d 29.5% vs a 20% ceiling** (the filed 19.0% was one cell). §1 binds, the onset yields. **Three levers measured and dead** — see backlog before proposing a fourth. |
