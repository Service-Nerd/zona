...
**Last updated:** 2026-08-02 (SLT-approved **engine recovery-awareness set** from the 29-Jul coach-trace assessment — root cause: the engine had no concept of *recovering from something*. Shipped: **DS-08** (temp/splits enrich-patch drop fix). Queued near-term: **ENGINE-05** post-race recovery gating (flagship, FREE structure/PAID voice), **ENGINE-06** morning-heat nudge (PAID), **ENGINE-07** fatigue coach-note (PAID). Rejected: weather-API heat, terrain-constraint. Deferred: R-B volume-hold, R22 taper-into-deload, R-F behind R24. Detail: backlog.md § Engine recovery-awareness.)
...
| ✅ | **DS-08** — enrich temp/splits drop fix | ✅ | S | Shipped 2026-08-02 (branch `feat/engine-recovery-awareness`). Recovery-awareness set; unblocks heat voice. |
| 🔄 | **ENGINE-05** — post-race recovery gating (R-A) | 🔄 | L | **Flagship.** FREE structure / PAID voice. Foundation-block prepend + recovery curve; de-dup guard vs MAINT-01. |
| 🔲 | **ENGINE-06** — morning-heat nudge (R-C(a)) | 🔲 | S | PAID. Depends on DS-08. Timezone-derive local hour first. |
| 🔲 | **ENGINE-07** — fatigue coach-note, 2 consec Heavy (R-B) | 🔲 | S | PAID. Note-only; structural volume-hold deferred (evidence-gated). |
