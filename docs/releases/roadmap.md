...
| ~~**The 54/54 marathon question**~~ (§23 ratio / §46 floor) | ⚖️ **BOARD RULED 2026-09-13 → MARATHON-MAINT-LABEL-01 (own build).** Re-measured with §106 live: still 100%. The lever is **NOT** §23/§46 — it is §24's peak-LR floor colliding with the 210-min long-run cap. Do not re-open the §23/§46 recalibration. Record: `docs/decisions/coaching-board-2026-09-13-batch.md` §2. |
