...
🔴 **STILL OPEN:** `PEAK-VS-DELIVERED-BUILD-01` (47.8% of experienced 70 km/wk marathoners get a DELIVERED peak under §23's 110%; the curve satisfies it, so curve-vs-delivered) · `S111`'s metric is **anti-correlated with its hazard** (a runner whose week cannot grow has a LOW peak, so a LOW ratio, so passes) · `CAT-DEPTH-01` · `DEVICE-VERIFY-01` (founder's phone).
