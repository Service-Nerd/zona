...
**Tagline**: "Slow down. You're not Kipchoge."  
...
The brand acknowledges the user's effort without validating the overtraining. It is on their side — which is why it tells them to slow down.
